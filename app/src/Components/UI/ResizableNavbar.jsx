...
export const Navbar = ({ children, className }) => {
  ...
  return (
    <motion.div
      ...
      className={cn("sticky inset-x-0 top-[68px] z-40 w-full", className)}
    >
...
export const NavbarLogo = () => {
  ...
  return (
    ...
    >
      <img
        src="https://i.postimg.cc/zBJqhfT3/main3.png"
        alt="logo"
        className="bg-white rounded-xl rounded-bl-none rounded-tr-none "
        width={43}
        height={43}
      />
