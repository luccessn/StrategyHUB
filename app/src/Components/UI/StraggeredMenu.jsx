    ...
    >
      ...
      >
        ...
        >
          ...
          <button
            ref={toggleBtnRef}
            className="sm-toggle -left-5 top-0 relative cursor-target p-2 inline-flex items-center gap-[0.3rem] bg-transparent border-0 cursor-pointer text-[#e9e9ef] font-medium leading-none overflow-visible pointer-events-auto"
            ...
            type="button"
          >
            <FaShoppingCart className=" text-xl font-bold hover:scale-110 transition-transform duration-150 cursor-pointer" />
            <span
              ref={textWrapRef}
        ...
        >
          <div className="sm-panel-inner overflow-y-hidden flex-1 flex flex-col gap-5">
            <div className="sm-panel-itemWrap  overflow-hidden relative -top-2 leading-none ">
              ...
              >
                <h1 className="sm-panel-itemLabel inline-block [transform-origin:50%_100%] will-change-transform">
                  Your Basket
                </h1>
              </div>
            </div>
            ...
            {/* // */}
            {/* // */}
            <div className="fixed  flex-col  bottom-0 left-0 w-full h-[100px]  items-center px-4 ">
              <div className="flex relative -top-5 text-2xl font-mono justify-between">
                <h1>Total :</h1>
                <h1>${totalAmount}</h1>
              </div>
              <div className="flex flex-row gap-10">
                <button
                  ...
                  className="rounded-lg cursor-target bg-purple-800 hover:bg-purple-950 pay-btn text-white text-medium ssm:text-xl flex items-center gap-2 px-4 py-2"
                >
