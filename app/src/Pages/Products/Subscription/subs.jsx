                  ...
                  <div className="flex flex-col gap-5">
                    {option.name === "Free" ? (
                      <p className="ml-2 font-satosIT text-zinc-500">
                        ...
                        assistant — with no restrictions during your trial
                        period.
                      </p>
                    ) : (
                      <p className="ml-2 font-satosIT text-zinc-500">
                        ...
                        your goals, track your progress, and refine your
                    ...
                    <ul>
                      {[
                        ...
                        option.name === "Free"
                          ? {
                              text: "Exclusive Access to Modules",
                              active: false,
                            }
                          : {
                              text: "Exclusive Access to Modules",
                        ...
                        option.name === "Free"
                          ? {
                              text: "Access to Future Features",
                              active: false,
                            }
                          : {
                              text: "Access to Future Features",
